...
export class CertificationsComponent {
  certificates = [
    ...
    { title: 'Angular (Basics)', imageUrl: 'assets/angular.png', link: 'https://www.hackerrank.com/certificates/e2d67f7b7d1d' },    { title: 'Css (Basics)', imageUrl: 'assets/css.png', link: 'https://www.hackerrank.com/certificates/a33f4bbf3046' }
